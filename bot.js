  ...
  if (message.content.startsWith("math.ping")) {
    ...
    message.channel.send("```math.help     Shows this information.\nmath.ping     Pings me.\nmath.invite   Invites me to your server.\nmath.server   Invites you to my server.\n\n" + config.prefix + "             Prefix.\n+             Add.\n-             Subtract.\n*             Multiply.\n/             Divide.\n%             Modulo.\n\npow(x, y)     Raises x to the power of y.\nsqrt(x)       Square root of x.\nfloor(x)      Rounds x down to nearest integer.\nceil(x)       Rounds x up to nearest integer.```");
     ...
     if (isFinite(message.content.toLowerCase().replace(/\=|\+|\-|\*|\/|\%|\(|\)|\,|\ |math.|pow|sqrt|round|floor|ceil|ceiling|pi|π|e|euler|abs|absolute|exp|log|logarithm|random|rand|rng/g,''))) {
      let calculate = message.content.toLowerCase().replace(/ /g, "").replace(/pow|power/g, "Math.pow").replace(/sqrt|squareroot/g, "Math.sqrt").replace(/round/g, "Math.round").replace(/floor/g, "Math.floor").replace(/ceil|ceiling/g, "Math.ceil").replace(/pi|π/g, "Math.PI").replace(/e|euler/g, "Math.E").replace(/abs|absolute/g, "Math.abs").replace(/exp/g, "Math.exp").replace(/log|logarithm/g, "Math.log").replace(/random|rand|rng/g, "Math.random()");/*.replace(/acos|arccosine/g, "Math.acos").replace(/asin|arcsine/g, "Math.asin").replace(/atan|arctangent|atan1|arctangent1/g, "Math.atan").replace(/atan2|arctangent2/g, "Math.atan2").replace(/cos|cosine/g, "Math.cos").replace(/sin|sine/g, "Math.sin").replace(/tan|tangent/g, "Math.tan")*/;
